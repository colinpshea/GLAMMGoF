...
When a GLMM includes random effects and a nonlinear link function (e.g., log or logit), backtransforming population-level (marginal) predictions to the response scale introduces a systematic bias. This occurs because of Jensen's inequality: for a convex function $f$ and a random variable $u$, $E[f(u)] > f(E[u])$. For a log-link model with random effects, this means:
