...
2.  The only other choices you need to make are:
    ...
    1.  The number of bootstrap or Monte Carlo replicates you want to (the default is `nReps=100` but this should be at least 500 or 1000).
...
2.  The only other choices you need to make are:
    ...
    1.  The number of bootstrap or Monte Carlo replicates you want to (the default `nReps=100` but this should be at least 500 or 1000).
