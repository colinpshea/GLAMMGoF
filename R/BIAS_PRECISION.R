    ...
    if (is_lognormal && inherits(testModel, "glmmTMB")) {
      ...
      if (has_dispformula) {
        stop(
          ...
          "e.g.:\n",
          "     cf <- jensen_correct_rowwise(testModel, newdata = testData)\n",
          ...
          "with bias_adjust = 'manual'. It auto-routes to jensen_correct_rowwise() ",
